class Hotel:
    ...
    def __init__(self, nome):
        self.nome = nome
        self.quartos = [AP_Luxo(i) for i in range(1, 3)] + [AP_Master(i) for i in range(3, 5)]
        + [AP_Simples(i) for i in range(5, 7)] + [AP_SimplesCasal(i) for i in range(7, 9)]
        + [AP_Duplo(i) for i in range(9, 11)] + [AP_DuploCasal(i) for i in range(11, 13)] 
        self.reservas = []
