                            ...
                            if senha_login == cliente.get_senha():
                                ...
                                match seleção:
                                    case 1:
                                        ...
                                        elif simples[1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif simples [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
                                    ...
                                    case 2:
                                        ...
                                        elif casal [1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif casal [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
                                    ...
                                    case 3:
                                        ...
                                        elif duplo [1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif duplo [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
                                    ...
                                    case 4:
                                        ...
                                        elif duplo_casal [1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif duplo_casal [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
                                    ...
                                    case 5:
                                        ...
                                        elif luxo [1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif luxo [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
                                    ...
                                    case 6:
                                        ...
                                        elif master [1] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")

                                        elif master [2] == "Indisponível":
                                            print("Quarto indisponível.")
                                            os.system("pause")
                                            os.system("cls")
